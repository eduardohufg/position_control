...
void calculatePID() {
  ...
  controlSignal = prev_controlSignal + errorValue * (derivative/deltaTime + proportional + integral*deltaTime) - error_k_1 * (2*derivative/deltaTime + proportional) + error_k_2*derivative/deltaTime;

  controlSignal = saturation(controlSignal, sat_control_signal * -1, sat_control_signal);

  error_k_2 = error_k_1;
  error_k_1 = errorValue;
